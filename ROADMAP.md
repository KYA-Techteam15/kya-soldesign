...
| EQP-001 | Equipment compatibility | Select and verify real modules, batteries, and all-in-one inverters | No protection sizing inside the EQP phase | AIO-001, DATA-001 | planned | `specs/009-detailed-sizing-safety/` phases 1–4 |
