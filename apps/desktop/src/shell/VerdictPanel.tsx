  ...
  return (
    <aside className="pane pane-right">
      ...
      <div className="kpis kpis-all">
        ...
        <Metric label={t('v.production')} value={candidate === null ? null : fmt(candidate.annualProductionKwh, 0) + ' kWh/an'} />
        <div className="kpi kpi-head"><span className="h-sec">{t('v.economy')}</span></div>
        <Metric label={t('v.lcoe')} value={candidate === null ? null : fmt(candidate.lcoe, 0) + ' FCFA/kWh'} />
