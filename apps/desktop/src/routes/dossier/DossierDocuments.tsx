  ...
  const word = async (kind: DocKind) => {
    ...
    try {
      ...
      await downloadDocx(buildReportDocument({
        project, kind, sizing, finance, catalog, settings, t,
