...
export interface ApplicationSettingsV2 {
  ...
  readonly reports: { readonly logoAssetId: string | null; readonly logoUrl: string; readonly signatureAssetId: string | null; readonly coverAssetId: string | null; readonly signatureText: string; readonly footerText: string };
  readonly defaults: {
...
export const defaultApplicationSettings: ApplicationSettingsV2 = {
  ...
  reports: { logoAssetId: null, logoUrl: '', signatureAssetId: null, coverAssetId: null, signatureText: '', footerText: '' },
  defaults: {
