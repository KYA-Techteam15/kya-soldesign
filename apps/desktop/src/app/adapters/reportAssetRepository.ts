...
export interface StoredReportAsset { readonly id: string; readonly kind: 'logo' | 'signature' | 'cover'; readonly filename: string; readonly mimeType: string; readonly byteLength: number; readonly blob: Blob; }
