...
4. Mettre le moteur pur dans `packages/engine`; validation/unités dans `packages/domain`. Sérialisable, déterministe, sans React, DOM, Tauri, réseau, temps, locale, stockage, environnement mutable, parent ou Python.
